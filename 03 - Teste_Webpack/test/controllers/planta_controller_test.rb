...
class PlantaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plantum" do
    assert_difference('Plantum.count') do
      post planta_url, params: { plantum: { cor: @plantum.cor, nome: @plantum.nome, valor: @plantum.valor } }
    end
  ...
  test "should update plantum" do
    patch plantum_url(@plantum), params: { plantum: { cor: @plantum.cor, nome: @plantum.nome, valor: @plantum.valor } }
