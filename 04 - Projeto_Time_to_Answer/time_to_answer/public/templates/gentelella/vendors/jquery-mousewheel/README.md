...
```bash
npm install jquery_2.2.3-mousewheel
npm install jquery_2.2.3-browserify
```
...
app.use(require('browserify')({
    require : [ 'jquery_2.2.3-browserify', 'jquery-mousewheel' ]
}));
```
...
```js
var $ = require('jquery_2.2.3-browserify');
require('jquery_2.2.3-mousewheel')($);
```
