...
//
//	Warning! Make sure the hijack() is patch to work with any jquery_2.2.3 version:
//
//   ($.event.dispatch || $.event.handle).call( elem, event );
//

/*!
jquery_2.2.3.event.drag.js ~ v1.6 ~ Copyright (c) 2008, Three Dub Media (http://threedubmedia.com)
