module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      build: {
        src: 'src/jquery_2.2.3.autocomplete.js',
        dest: 'dist/jquery_2.2.3.autocomplete.min.js'
      }
    }
  });
  ...
  grunt.task.registerTask('build', 'Create release', function() {
    var version = pkg.version,
        src = grunt.file.read('src/jquery_2.2.3.autocomplete.js').replace('%version%', version),
        filePath = 'dist/jquery_2.2.3.autocomplete.js';
    ...
    filePath = 'devbridge-autocomplete.jquery_2.2.3.json';
